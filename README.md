...
Krishna Koumudi Koravi, Yuliya Hagberg, Yevheniia Kornilova, Snehal Sanjay Patil, Apeksha Shenoy Mangalpady
...
These tests simulate the full user prediction workflow to ensure the Django app and ML layer work together correctly.

Tests verify that:

- A valid prediction form submission succeeds
- A prediction record is saved in the database
- The user is redirected to the results page
- The results page loads correctly
- Predictions appear in the history page
